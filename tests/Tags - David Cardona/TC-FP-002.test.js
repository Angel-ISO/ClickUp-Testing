...
taggedDescribe(
  ...
  "TC-FP-002 - Verify successful update of an existing Space Tag",
  () => {
    ...
    it("Get Tags - Verify Tag Update", async () => {
      ...
      expect(tag).toHaveProperty("tag_fg");
      expect(tag).toHaveProperty("tag_bg");
      expect(tag.tag_fg.toUpperCase()).toBe(
        updatedTagData.tag.tag_fg.toUpperCase()
      );
      expect(tag.tag_bg.toUpperCase()).toBe(
        updatedTagData.tag.tag_bg.toUpperCase()
      );
